...
def recognum(i):
  ...
  # dir_path= r"C:\Users\Я\PycharmProjects\NumRec\Images_log"
  ...
  if text!= None:
    ...
    print(text)
    query = "INSERT INTO parking_logs (car_number) VALUES (%s)"
    values = (text,)
    mycursor.execute(query, values)
    mydb.commit()
    image = Image.fromarray(res)
    image.save(fr"C:\Users\Я\PycharmProjects\NumRec\Images_log\{i}.png")

    query = "INSERT INTO Images (filepath) VALUES (%s)"
    values = (fr"C:\Users\Я\PycharmProjects\NumRec\Images_log\{i}.png",)
    mycursor.execute(query, values)
    mydb.commit()
  else:
